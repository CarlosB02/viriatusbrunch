...
import { Phone, AtSign, MapPin, Clock, Mail } from 'lucide-react';
        ...
        <div className="container" style={{ maxWidth: '1100px' }}>
          ...
          >
            ...
            <p style={{ color: 'var(--text-gray)', fontSize: '1.1rem', maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
              Tens alguma dúvida ou queres garantir a tua mesa? Estamos aqui para tornar o teu brunch inesquecível.
            </p>
          </motion.div>
